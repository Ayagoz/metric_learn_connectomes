...
table = pipeliner.get_results(X, y, scoring=['roc_auc'], caching_steps = ['normalization1','normalization2','features','selection'], logs_file = 'log/ucla_results_SDML_exp_spectral.log')


table.to_csv('ucla_results_SDML_exp_spectral', sep = '\t')